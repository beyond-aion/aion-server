...
public class MySQL5AccountPassportsDAO extends AccountPassportsDAO {
	...
	public static final String SELECT_QUERY = "SELECT `passportid`, `rewarded`, `arrive_date` FROM `account_passports` WHERE `account_id`=?";
	public static final String UPDATE_QUERY = "UPDATE `account_passports` SET `rewarded`=? WHERE `account_id`=? AND `passportid`=?";
	...
	public static final String INSERT_QUERY = "INSERT INTO `account_passports` (`account_id`, `passportid`, `rewarded`, `arrive_date`) VALUES (?,?,?,?)";
	public static final String DELETE_QUERY = "DELETE FROM `account_passports` WHERE account_id = ? AND passportid = ? and arrive_date = ?";
	...
	@Override
	public void store(int accountId, List<Passport> pList) { 
	...
	public void store(Account account) { 
	   store(account.getId(), account.getPassportsList().getAllPassports());
