	...
	public void execute(Player admin, String... params) {
		...
		if (target instanceof Player) {
			...
			PacketSendUtility.sendMessage(admin, "[Stats]" + "\nPvP attack: "
				+ player.getGameStats().getStat(StatEnum.PVP_ATTACK_RATIO, 0).getCurrent() * 0.1f + "%" + "\nPvP p. attack: "
			...
			PacketSendUtility.sendMessage(admin, "[Life stats]" + "\nisAlive: " + !player.getLifeStats().isAlreadyDead() + "\nHP: "
				+ player.getLifeStats().getCurrentHp() + " / " + player.getLifeStats().getMaxHp() + "\nMP: " + player.getLifeStats().getCurrentMp() + " / "
				+ player.getLifeStats().getMaxMp());
			...
			PacketSendUtility.sendMessage(admin, "[Info about target]" + "\nName: " + npc.getName() + "\nId: " + npc.getNpcId() + " / ObjectId: "
				...
				+ admin.getTarget().getX() + " / Y: " + admin.getTarget().getY() + " / Z: " + admin.getTarget().getZ() + " / Heading: "
