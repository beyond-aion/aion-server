...
import static com.aionemu.gameserver.network.aion.serverpackets.SM_SYSTEM_MESSAGE.STR_NOT_ENOUGH_MONEY;
	...
	public void execute(Player player, String... params) {
		...
		if (!CustomConfig.FACTION_FREE_USE) {
			if (sender.getKinah() > CustomConfig.FACTION_USE_PRICE)
				...
				PacketSendUtility.sendPacket(player, STR_NOT_ENOUGH_MONEY);
				return;
			}
		}
