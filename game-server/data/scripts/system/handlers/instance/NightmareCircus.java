 ...
 * @author Ritsu
 */
@InstanceID(301160000) // aka Rukibuki Zirkus
	...
	public void onEnterInstance(final Player player) {
		ThreadPoolManager.getInstance().schedule(new Runnable() {
			...
			public void run() {
				...
				sendMsg(831551, 1500972);
				sendMsg(831552, 1500971);
				sendMsg(831553, 1500970);
			}
		}, 1000);
	}
		...
		spawnTask = ThreadPoolManager.getInstance().schedule(new Runnable() {
			...
			public void run() {
				if (!isInstanceDestroyed) {
					...
					// Wave 8
					sp(233450, 524.41406f, 628.0354f, 207.97612f, (byte) 90, 1501005, 70000, "3011600001");
					...
					sp(233450, 521.329f, 626.74036f, 207.89403f, (byte) 90, 1501005, 70000, "3011600004");
					...
					// Wave 15
					sp(233455, 524.41406f, 628.0354f, 207.97612f, (byte) 90, 1500985, 140000, "3011600001");
					sp(233455, 521.2755f, 628.16846f, 208.06583f, (byte) 90, 1501006, 140000, "3011600002");
					sp(233455, 524.4364f, 626.2443f, 207.68132f, (byte) 90, 1500985, 140000, "3011600003");
					sp(233455, 521.329f, 626.74036f, 207.89403f, (byte) 90, 1501006, 140000, "3011600004");
					...
					// Wave 9
					sp(233450, 523.77045f, 494.52615f, 198.37659f, (byte) 90, 1501005, 80000, "3011600005");
					...
					sp(233450, 521.4548f, 496.7582f, 198.46896f, (byte) 90, 1501005, 80000, "3011600008");
					...
					// Wave 15
					sp(233450, 523.77045f, 494.52615f, 198.37659f, (byte) 90, 1500985, 140000, "3011600005");
					sp(233450, 521.3197f, 494.83768f, 198.40182f, (byte) 90, 1501006, 140000, "3011600006");
					sp(233450, 523.791f, 496.6259f, 198.52597f, (byte) 90, 1500985, 140000, "3011600007");
					sp(233450, 521.4548f, 496.7582f, 198.46896f, (byte) 90, 1501006, 140000, "3011600008");

					// Mistress Viloa
					sp(233459, 549.0792f, 565.6647f, 198.83736f, (byte) 60, 1500989, 160000);
					// Harlequin Lord Reshka
					sp(233453, 549.0792f, 565.6647f, 198.83736f, (byte) 60, 1500996, 200000);
					// Nightmare Lord Heiramune
					sp(233467, 549.0792f, 565.6647f, 198.83736f, (byte) 60, 1500983, 300000);
				}
			}
		}, 300);
	}
	...
	public void onDie(Npc npc) {
		...
		switch (npc.getNpcId()) {
			...
			case 233467:
				...
				sendMsg(831559, 1500964);
				sendMsg(831561, 1500965);
				sendMsg(831562, 1500973);
				break;
		}
	}
