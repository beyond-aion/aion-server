		...
		switch (npc.getNpcId()) {
			...
			case 216586: //Temadaro (Difficult)
				...
				if (killedCount < 12) {
					...
					npcMacunbello = (Npc) spawn(216734, 981.015015f, 134.373001f, 241.755005f, (byte) 30); // 2th strongest
																																																	// macunbello
					SkillEngine.getInstance().applyEffectDirectly(19047, npcMacunbello, npcMacunbello, 0);
				}
				else if (killedCount < 21) {
					npcMacunbello = (Npc) spawn(216737, 981.015015f, 134.373001f, 241.755005f, (byte) 30); // 2th weakest
																																																	// macunbello
