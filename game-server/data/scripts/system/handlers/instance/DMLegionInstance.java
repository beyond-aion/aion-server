...
public class DMLegionInstance extends GeneralInstanceHandler {
	...
	public void onOpenDoor(int door) {
		switch (door) {
			...
			case 101:
				...
				spawn(233252, 208.69122f, 506.90762f, 153.22841f, (byte) 90);
				break;
			case 6:
				...
				spawn(233252, 228.23853f, 534.5297f, 153.03906f, (byte) 90);
				break;
			case 7:
				...
				spawn(233252, 237.19664f, 542.329f, 152.59001f, (byte) 90);
				break;
			case 8:
				...
				spawn(233252, 259.48843f, 548.554f, 150.50136f, (byte) 90);
				break;
			case 10:
				...
				spawn(233252, 290.86472f, 551.13293f, 148.7211f, (byte) 90);
				break;
			case 11:
				...
				spawn(233252, 316.13455f, 547.49786f, 148.79962f, (byte) 90);
				break;
			case 12:
				...
				spawn(233252, 335.43216f, 537.36707f, 148.47159f, (byte) 90);
				break;
			case 13:
				...
				spawn(233252, 347.2264f, 517.13245f, 148.18051f, (byte) 90);
				break;
		}
	}
	...
	private void doReward(int rank, Npc boss) {
		...
		switch (rank) {
			case 1:
				spawn(233253, 556.36096f, 416.39127f, 96.81002f, (byte) 100); // spawn last boss
			case 2:
			case 3:
			...
			case 4:
				...
				dropItems.add(DropRegistrationService.getInstance().regDropItem(1, 0, boss.getNpcId(), 185000165, 1));
				break;
			default:
				break;
		}
	...
	public void onInstanceCreate(WorldMapInstance instance) {
		...
		spawn(Rnd.get(233264, 233265), 520.6471f, 468.8483f, 95.58755f, (byte) 40); // captain spawn
		if (instanceTimer == null) {
			startTime = System.currentTimeMillis();
