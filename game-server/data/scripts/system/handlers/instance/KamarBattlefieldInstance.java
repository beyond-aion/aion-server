...
public class KamarBattlefieldInstance extends GeneralInstanceHandler {
    ...
    public void onEnterInstance(Player player) {
        ...
        PacketSendUtility.sendPacket(player, new SM_INSTANCE_SCORE(new KamarBattlefieldScoreInfo(kamarReward, 6, player.getObjectId()), kamarReward, getTime()));
        //sendPacket();
    }
    ...
    public boolean onDie(Player player, Creature lastAttacker) {
        ...
        if (lastAttacker instanceof Player) {
            if (lastAttacker.getRace() != player.getRace()) {
                ...
                sendPacket(new SM_INSTANCE_SCORE(new KamarBattlefieldScoreInfo(kamarReward, 10, lastAttacker.getRace().equals(Race.ELYOS) ? 0 : 1), kamarReward, getTime()));
            }
        }
