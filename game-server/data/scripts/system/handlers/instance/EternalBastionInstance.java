...
public class EternalBastionInstance extends GeneralInstanceHandler {
    ...
    private SpawnTemplate rndSpawnInRange(Npc npc, int npcId) {
        ...
        return SpawnEngine.addNewSingleTimeSpawn(instance.getMapId(), npcId, npc.getPosition().getX() + x1, npc.getPosition().getY() + y1, npc.getPosition().getZ(), npc.getPosition().getHeading());
    }
