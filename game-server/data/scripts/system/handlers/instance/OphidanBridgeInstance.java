...
public class OphidanBridgeInstance extends GeneralInstanceHandler {
    ...
    private void spawnBridgeBarrier() {
        FlyRing f1 = new FlyRing(new FlyRingTemplate("OPHIDIAN_BRIDGE_1", mapId,
                new Point3D(435.25446, 496.38007, 604.8871),
                new Point3D(435.25446, 496.38007, 616.8871),
                new Point3D(432.8339, 508.1334, 604.8871), 12), instanceId);
        f1.spawn();

        FlyRing f2 = new FlyRing(new FlyRingTemplate("OPHIDIAN_BRIDGE_2", mapId,
                new Point3D(429.2187, 495.9813, 604.9689),
                new Point3D(429.2187, 495.9813, 616.9689),
                new Point3D(426.79813, 507.73462, 604.9689), 12), instanceId);
        f2.spawn();

        FlyRing f3 = new FlyRing(new FlyRingTemplate("OPHIDIAN_BRIDGE_3", mapId,
                new Point3D(424.53012, 495.6659, 604.9849),
                new Point3D(424.53012, 495.6659, 616.9849),
                new Point3D(422.10956, 507.41922, 604.9849), 12), instanceId);
        f3.spawn();
    }
