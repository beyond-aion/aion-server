...
public class KrotanBattleInstance extends KrotanBattleInstance_L {
	...
	protected void spawnChests(Npc npc) {
		if (!rewarded) {
			...
			spawn(702288, 545.4042f, 892.1157f, 199.37367f, (byte) 83);
			spawn(702288, 528.2692f, 895.10614f, 199.37366f, (byte) 89);
			spawn(702288, 511.3643f, 891.9409f, 199.37367f, (byte) 96);
			spawn(702288, 496.22192f, 883.09937f, 199.37367f, (byte) 103);
			spawn(702288, 484.93253f, 869.89667f, 199.37427f, (byte) 109);
			spawn(702288, 479.12225f, 853.5763f, 199.37297f, (byte) 116);
			spawn(702288, 478.9662f, 836.40704f, 199.37367f, (byte) 2);
			spawn(702288, 485.365f, 820.3497f, 199.45955f, (byte) 9);
