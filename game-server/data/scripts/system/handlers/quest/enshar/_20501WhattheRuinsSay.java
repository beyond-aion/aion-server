			...
			case 804722: // Putrid Balaur Corpse.
				if(var == 6) { // Step 6: Examine the Putrid Balaur Corpse.
					...
					if (dialog == DialogAction.SET_SUCCEED) {
						...
						if (npc != null)
							QuestService.addNewSpawn(220080000, player.getInstanceId(), 219935, npc.getPosition().getX(), npc.getPosition().getY(), npc.getPosition().getZ(), npc.getPosition().getHeading());
