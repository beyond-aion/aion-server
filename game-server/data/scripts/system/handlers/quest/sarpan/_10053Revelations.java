...
public class _10053Revelations extends QuestHandler {
	...
	public void register() {
		...
		qe.registerQuestNpc(218890).addOnAttackEvent(questId);
	}
	...
	public boolean onAttackEvent(QuestEnv env) 
	{
		...
		if (qs != null && qs.getStatus() == QuestStatus.START)
		{
			...
			if (targetId == 218890 && var == 3) 
			{
				...
				QuestService.spawnQuestNpc(300330000, player.getInstanceId(), 205795, 250.331f, 245.210f, 126.270f, (byte) 60);
				QuestService.spawnQuestNpc(300330000, player.getInstanceId(), 730498, 211.820f, 244.359f, 124.942f, (byte) 30, 8); // Flowing Dimensional Exit
