...
public class _23531MoreSpiritsMoreGrudges extends QuestHandler {
	...
	int[] mobs = { 233302, 233303, 233304, 233305};
    ...
    public boolean onDialogEvent(QuestEnv env) {
        ...
        if (qs == null || qs.getStatus() == QuestStatus.NONE) {
            ...
            if (dialog == DialogAction.SET_SUCCEED && qs.getQuestVarById(1) == 1 
            		&& qs.getQuestVarById(2)== 1 && qs.getQuestVarById(3)== 1 && qs.getQuestVarById(4)== 1)    {
