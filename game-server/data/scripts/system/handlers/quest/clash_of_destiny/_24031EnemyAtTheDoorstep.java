...
public class _24031EnemyAtTheDoorstep extends QuestHandler {
		...
		if (qs.getStatus() == QuestStatus.START) {
			...
			case 730888://Teleporter Device				
				...
				case QUEST_SELECT:{
					...
					qs.setQuestVar(11);
					updateQuestStatus(env);
					QuestService.addNewSpawn(320040000, player.getInstanceId(), 730898, (float) 262.9, (float) 224.5, (float) 212.2, (byte) 95);//Broken Teleporter Device
				}
				}
				break;
	...
	public boolean onEnterWorldEvent(QuestEnv env) {
		...
		if (qs != null && qs.getStatus() == QuestStatus.START) {
			...
			{
				QuestService.addNewSpawn(320040000, player.getInstanceId(), 730888, (float) 262.9, (float) 224.5, (float) 211.2, (byte) 95);//Shattered Large Teleporter
				QuestService.addNewSpawn(320040000, player.getInstanceId(), 233879, (float) 262.9, (float) 224.5, (float) 211.2, (byte) 95);//Captain Hagarkan
			}
		}
		return false;
	}
