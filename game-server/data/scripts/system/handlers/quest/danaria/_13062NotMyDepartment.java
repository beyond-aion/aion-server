 ...
 *
 */
public class _13062NotMyDepartment extends QuestHandler {

	private static final int questId = 13062;
	private static int[] mobs = {230557,230558};

	public _13062NotMyDepartment()
	{
		super(questId);
	}
	...
	{
		qe.registerQuestNpc(801098).addOnQuestStart(questId);
		qe.registerQuestNpc(801144).addOnTalkEvent(questId);
		qe.registerQuestNpc(801140).addOnTalkEvent(questId);
		qe.registerQuestNpc(801098).addOnTalkEvent(questId);
		for (int mob : mobs) {
