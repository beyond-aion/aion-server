 ...
 * @author Cheatkiller
 */
public class _47113TurningUpTheAmplifiers extends AbstractQuestHandler {
			...
			if (targetId == 700972) {
				if (player.isInGroup()) {
					...
					for (Player member : group.getMembers()) {
						if (player.isMentor() && PositionUtil.getDistance(player, member) < GroupConfig.GROUP_MAX_DISTANCE) {
