...
public class _12846AsmodianInfiltrators extends QuestHandler {
	...
	public void register() {
		...
		qe.registerOnEnterZone(ZoneName.get("STELLMANS_VALLEY_600050000"), questId);
	...
	public boolean onKillInWorldEvent(QuestEnv env) {
		...
		if (env.getVisibleObject() instanceof Player && player != null && player.isInsideZone(ZoneName.get("STELLMANS_VALLEY_600050000"))) {
	...
	public boolean onEnterZoneEvent(QuestEnv env, ZoneName zoneName) {
		if (zoneName == ZoneName.get("STELLMANS_VALLEY_600050000")) {
			Player player = env.getPlayer();
			if (player == null)
				return false;
			QuestState qs = player.getQuestStateList().getQuestState(questId);
