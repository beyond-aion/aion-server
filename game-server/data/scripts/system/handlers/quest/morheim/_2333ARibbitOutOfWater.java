			...
			if (targetId == 798084) { 
				if (dialog == DialogAction.QUEST_SELECT) {
				  ...
				  return checkQuestItems(env, 0, 1, false, 10000, 10001);
					...
					player.getController().addTask(TaskId.QUEST_FOLLOW, QuestTasks.newFollowingToTargetCheckTask(env, debrie, ZoneName.get("DF2_SENSORYAREA_Q2333_206057_1_220020000")));
