 ...
 * @author Pad
 */
public class _18738TestBombTestBomb extends QuestHandler {

	private static final int questId = 18738, skillId = 10981;
	private static final int[] npcIds = { 206378, 206379, 206380, 804965, 702694 };

	public _18738TestBombTestBomb() {
		super(questId);
	}
	...
	public boolean onUseSkillEvent(QuestEnv env, int skillId) {
		...
		if (qs != null && qs.getStatus() == QuestStatus.START) {
			...
			if (var0 == 0 && skillId == _18738TestBombTestBomb.skillId) {
				if (var1 < 9) {
