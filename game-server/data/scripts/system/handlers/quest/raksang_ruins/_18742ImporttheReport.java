 ...
 * @author Pad
 */
public class _18742ImporttheReport extends QuestHandler {

	private static final int questId = 18742;
	private static final int itemId = 182215694;
	//TODO: fix quest start, 8047XX Abisos are working
	private static final int[] npcIds = { 804700, 804707 };

	public _18742ImporttheReport() {
		super(questId);
	}
