		...
		if (qs.getStatus() == QuestStatus.START) {
			...
			case 730888://Large Teleporter			
				...
				case QUEST_SELECT:{
					...
					QuestService.addNewSpawn(320040000, player.getInstanceId(), 730898, (float) 257, (float) 257, (float) 226.35, (byte) 95);//Broken Teleporter Device
				}
				}
				break;
	...
	public boolean onEnterWorldEvent(QuestEnv env) {
		...
		if (qs != null && qs.getStatus() == QuestStatus.START) {
			...
			if (var == 9 && player.getWorldId() == 320040000) {
				QuestService.addNewSpawn(320040000, player.getInstanceId(), 730888, (float) 257, (float) 257, (float) 226.35, (byte) 95);//Shattered Large Teleporter
				QuestService.addNewSpawn(320040000, player.getInstanceId(), 233878, (float) 262.9, (float) 224.5, (float) 211.348, (byte) 95);//Captain Tarbana
				QuestService.addNewSpawn(320040000, player.getInstanceId(), 233886, (float) 217.015, (float) 221.694, (float) 207.49455, (byte) 97);//Baranath Sentinel
				QuestService.addNewSpawn(320040000, player.getInstanceId(), 233886, (float) 239.732, (float) 211.250, (float) 209.19, (byte) 97);//Baranath Sentinel
				QuestService.addNewSpawn(320040000, player.getInstanceId(), 233886, (float) 257.065, (float) 204.49, (float) 209.094, (byte) 97);//Baranath Sentinel
				QuestService.addNewSpawn(320040000, player.getInstanceId(), 233886, (float) 274.899, (float) 199.398, (float) 208.83487, (byte) 97);//Baranath Sentinel
				QuestService.addNewSpawn(320040000, player.getInstanceId(), 233886, (float) 282.878, (float) 223.742, (float) 208.252, (byte) 97);//Baranath Sentinel
			}
		}
		return false;
	}
