...
public enum ItemGroup {
	...
	RB_GLOVES(1 << 4, ItemSubType.ROBE, new int[] { 103, 106 }),
	...
	CL_GLOVES(1 << 4, ItemSubType.CLOTHES, new int[] { 40 }),
	...
	LT_GLOVES(1 << 4, ItemSubType.LEATHER, new int[] { 41, 48 }),
	...
	CH_GLOVES(1 << 4, ItemSubType.CHAIN, new int[] { 42, 49 }),
	...
	PL_GLOVES(1 << 4, ItemSubType.PLATE, new int[] { 54 }),
	...
	LT_HEAD(1 << 2, ItemSubType.LEATHER),
	CL_HEAD(1 << 2, ItemSubType.CLOTHES),
