...
public class PlayerTeamCommandService {
	...
	public static final void executeCommand(Player player, TeamCommand command, int playerObjId) {
		...
		Preconditions.checkArgument(playerObjId == 0 || command == TeamCommand.LEAGUE_SET_LEADER || teamSubjective.getObjectId().equals(playerObjId) || command == TeamCommand.LEAGUE_EXPEL,
