...
public enum DialogAction {
	...
	SELECT_ACTION_2719(2719),
	SELECT_ACTION_2720(2720),
	SELECT_ACTION_2803(2803),
	...
	SELL(3),
	SET_SUCCEED(10255), // aka SET_REWARD
	SETPRO1(10000),
	SETPRO2(10001),
	SETPRO3(10002),
	SETPRO4(10003),
	...
	static {
		for (DialogAction action : values()) {
			if (actionsById.putIfAbsent(action.id(), action) != null)
				throw new IllegalArgumentException("Action ID of " + action + " is already set for " + getByActionId(action.id));
		}
	}
