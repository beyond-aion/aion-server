...
public class TargetStatusProperty {
	...
	public static final boolean set(final Skill skill, Properties properties) {
		...
		if (skill.getSkillTemplate().getPenaltySkillId() == 8674)//TODO find why(skill_id="3842" name="Protective Shell I" target_status="STUN STAGGER STUMBLE SPIN OPENAERIAL")
			result = true;
