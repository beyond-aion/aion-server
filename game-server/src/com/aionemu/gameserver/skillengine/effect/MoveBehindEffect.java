...
public class MoveBehindEffect extends DamageEffect {
	...
	public void calculate(Effect effect) {
		...
		Vector3f closestCollision = GeoService.getInstance().getClosestCollision(effector, effected.getX() + x1, effected.getY() + y1, effected.getZ(), IgnoreProperties.of(effector.getRace()));
