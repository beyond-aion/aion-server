...
public class Effects {
	...
	public boolean isDamageEffect() {
		if (this.isEffectTypePresent(EffectType.BACKDASH) ||
			this.isEffectTypePresent(EffectType.CARVESIGNET) ||
			this.isEffectTypePresent(EffectType.DASH) ||
			this.isEffectTypePresent(EffectType.DEATHBLOW) ||
			this.isEffectTypePresent(EffectType.DELAYEDSPELLATTACKINSTANT) ||
			this.isEffectTypePresent(EffectType.DISPELBUFFCOUNTERATK) ||
			this.isEffectTypePresent(EffectType.MOVEBEHIND) ||
			this.isEffectTypePresent(EffectType.NOREDUCESPELLATKINSTANT) ||
			this.isEffectTypePresent(EffectType.PROCATKINSTANT) ||
			this.isEffectTypePresent(EffectType.SIGNETBURST) ||
			this.isEffectTypePresent(EffectType.SKILLATKDRAININSTANT) ||
			this.isEffectTypePresent(EffectType.SKILLATTACKINSTANT) ||
			this.isEffectTypePresent(EffectType.SPELLATKDRAININSTANT) ||
	...
	public boolean isSummoning() {
		if (this.isEffectTypePresent(EffectType.SUMMON) ||
			this.isEffectTypePresent(EffectType.SUMMONBINDINGGROUPGATE) ||
			this.isEffectTypePresent(EffectType.SUMMONFUNCTIONALNPC) ||
			this.isEffectTypePresent(EffectType.SUMMONGROUPGATE) ||
			this.isEffectTypePresent(EffectType.SUMMONHOMING) ||
			this.isEffectTypePresent(EffectType.SUMMONHOUSEGATE) ||
			this.isEffectTypePresent(EffectType.SUMMONSERVANT) ||
			this.isEffectTypePresent(EffectType.SUMMONSKILLAREA) ||
			this.isEffectTypePresent(EffectType.SUMMONTOTEM) ||
			this.isEffectTypePresent(EffectType.SUMMONTRAP))
			return true;
		else
			return false;
	}
