...
public class CommandsConfig {
	...
	@Property(key = "access", defaultValue = "3")
	...
	@Property(key = "cleanmail", defaultValue = "3")
	public static int CLEANMAIL;
	...
	@Property(key = "fix", defaultValue = "0")
	...
	@Property(key = "stoken", defaultValue = "5")
	public static int STOKEN;
	@Property(key = "rename_legion", defaultValue = "5")
	public static int RENAME_LEGION;
	@Property(key = "rename_player", defaultValue = "5")
	public static int RENAME_PLAYER;
	@Property(key = "lock", defaultValue = "5")
