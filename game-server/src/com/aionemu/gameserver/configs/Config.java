...
public class Config {
	...
	private static final List<Class<?>> CONFIGS = Arrays.asList(AdminConfig.class, CommandsConfig.class, DeveloperConfig.class, AIConfig.class,
		AutoGroupConfig.class, CommonsConfig.class, CacheConfig.class, CleaningConfig.class, CraftConfig.class, CustomConfig.class, DropConfig.class,
		EventsConfig.class, FallDamageConfig.class, GSConfig.class, GeoDataConfig.class, GroupConfig.class, HousingConfig.class, HTMLConfig.class,
		InGameShopConfig.class, LegionConfig.class, LoggingConfig.class, MembershipConfig.class, NameConfig.class, PeriodicSaveConfig.class,
