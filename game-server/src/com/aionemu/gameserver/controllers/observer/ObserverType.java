...
public enum ObserverType {
	...
	ALL(MOVE.observerMask | ATTACK.observerMask | ATTACKED.observerMask | STARTSKILLCAST.observerMask | DEATH.observerMask |
			DOT_ATTACKED.observerMask | ITEMUSE.observerMask | NPCDIALOGREQUEST.observerMask | ABNORMALSETTED.observerMask |
			SUMMONRELEASE.observerMask | SIT.observerMask | ENDSKILLCAST.observerMask | HP_CHANGED.observerMask | BOOSTSKILLCOST.observerMask);
