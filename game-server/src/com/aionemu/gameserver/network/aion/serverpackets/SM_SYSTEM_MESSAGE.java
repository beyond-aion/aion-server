...
public final class SM_SYSTEM_MESSAGE extends AionServerPacket {
	...
	*/
	public static SM_SYSTEM_MESSAGE STR_BUY_SELL_HE_DOES_NOT_SELL_ITEM(int npcNameId) {
	...
	*/
	public static SM_SYSTEM_MESSAGE STR_STIGMA_YOU_CANNOT_USE_THIS_SKILL_AFTER_UNEQUIP_STIGMA_STONE(int value0) {
	...
	*/
	public static SM_SYSTEM_MESSAGE STR_STIGMA_CANNT_UNEQUIP_STONE_OTHER_STONE_NEED_ITS_SKILL(int value0, int value1) {
	...
	*/
	public static SM_SYSTEM_MESSAGE STR_GIVE_ITEM_OPTION_IT_CAN_NOT_BE_GIVEN_OPTION(DescriptionId descriptionId, int targetItemNameId) {
	...
	*/
	public static SM_SYSTEM_MESSAGE STR_GIVE_ITEM_OPTION_IT_CAN_NOT_BE_GIVEN_OPTION_MORE_TIME(DescriptionId descriptionId, int targetItemNameId) {
	...
	*/
	public static SM_SYSTEM_MESSAGE STR_REMOVE_ITEM_OPTION_NO_OPTION_TO_REMOVE(DescriptionId descriptionId) {
	...
	*/
	public static SM_SYSTEM_MESSAGE STR_REMOVE_ITEM_OPTION_INVALID_OPTION_SLOT_NUMBER(DescriptionId descriptionId) {
	...
	*/
	public static SM_SYSTEM_MESSAGE STR_REMOVE_ITEM_OPTION_NOT_ENOUGH_GOLD(DescriptionId descriptionId) {
	...
	*/
	public static SM_SYSTEM_MESSAGE STR_MSG_QUEST_COMPLETE_ERROR_QUEST_ITEM_RETRY(DescriptionId descriptionId) {
	...
	*/
	public static SM_SYSTEM_MESSAGE STR_CANNOT_OPEN_DOOR_NEED_NAMED_KEY_ITEM(DescriptionId descriptionId) {
...
/ChannelHelp: Shows the commands available for channels.
	...
	*/
	public static SM_SYSTEM_MESSAGE STR_GATHER_OUT_OF_SKILL_POINT(int nameId) {
	...
	*/
	public static SM_SYSTEM_MESSAGE STR_GATHER_LEARN_SKILL(int nameId) {
	...
	*/
	public static SM_SYSTEM_MESSAGE STR_MSG_DONT_GET_PRODUCTION_EXP(int nameId) {
	...
	*/
	public static SM_SYSTEM_MESSAGE STR_MSG_CANT_CHANGE_SKIN_OPPOSITE_REQUIREMENT(DescriptionId item1, DescriptionId item2) {
	...
	*/
	public static SM_SYSTEM_MESSAGE STR_MSG_CANT_GATHERING_B_ITEM_CHECK(int nameId) {
	...
	*/
	public static SM_SYSTEM_MESSAGE STR_MSG_ITEM_AUTHORIZE_SUCCEEDED_MAX(String playerName, int nameId) {
	...
	*/
	public static SM_SYSTEM_MESSAGE STR_UNCOMPRESS_COMPRESSED_ITEM_SUCCEEDED(DescriptionId value0) {
	...
	* %0 was automatically entrusted with the league leader authority.
	*/
	public static SM_SYSTEM_MESSAGE STR_UNION_CHANGE_LEADER_TIMEOUT(String value0, String value1, String value2) {
	...
	*/	
	...
	/**
	 * У персонажа %0 обнулено очков славы: %1%[%gchar:glory_point].
	 */
	...
	/**
	 * В зависимости от вашего текущего ранга определенное количество очков славы будет с вас сниматься ежедневно.
	 */
