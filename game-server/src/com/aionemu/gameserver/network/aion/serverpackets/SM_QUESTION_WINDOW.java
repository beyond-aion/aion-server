...
public class SM_QUESTION_WINDOW extends AionServerPacket {
	...
	/**
	 * The Legion will remain in disbanding mode for a day following your request. Are you sure you wish to 
	 * &lt;font color="ff0000"&gt;disband&lt;/font&gt; the Legion?
	 */
	...
	/**
	 * &lt;p&gt;You can restore XP and remove the resurrection aftereffect if your soul is healed. Soul healing requires 
	 * &lt;font font_xml="v3_msgbox_money"&gt;%qina0&lt;/font&gt;.&lt;/p&gt;&lt;p&gt;Do you want to heal your soul?&lt;/p&gt;
	 */
	...
	/**
	 * &lt;p&gt;To expand the cube you need &lt;font font_xml="v3_msgbox_money"&gt;%qina0&lt;/font&gt; Kinah.&lt;/p&gt;
	 * &lt;p&gt;Do you want to expand it?&lt;/p&gt;
	 */
	public static final int STR_WAREHOUSE_EXPAND_WARNING = 900686;
	
	/**
	 * To upgrade the %0 skill, you need 
	 * &lt;font font_xml="v3_msgbox_money"&gt;%qina1&lt;/font&gt;. Are you sure you want to upgrade the skill?
	 */
	public static final int STR_CRAFT_ADDSKILL_CONFIRM = 900852;
	
	/**
	 * &lt;p align="left"&gt;%0 is about to summon you using %1. Will you accept?&lt;/p&gt;
	 * &lt;p&gt;&lt;/p&gt;&lt;p align="left"&gt;You must decide in %2 seconds.&lt;/p&gt;
	 */
	...
	/**
	 * &lt;p&gt;The %0 must be soulbound to equip it.&lt;/p&gt;
	 * &lt;p&gt;You cannot trade the item that has been soulbound.&lt;/p&gt;
	 * &lt;p&gt;Equip?&lt;/p&gt;
	 */
	 ...
	 * &lt;/p&gt;&lt;p&gt;You need &lt;font font_xml="v3_msgbox_money"&gt;%qina0&lt;/font&gt;to do this.
	 * Are you sure you want to condition them?&lt;/p&gt;
	 */
	public static final int STR_ITEM_CHARGE_ALL_CONFIRM = 903026;

	public static final int STR_ITEM_CHARGE2_ALL_CONFIRM = 904039;
	/**
	 * &lt;p&gt;You can condition only %0 of the registered items up to level %1.
	 * &lt;/p&gt;&lt;p&gt;You need &lt;font font_xml="v3_msgbox_money"&gt;%qina2&lt;/font&gt;to do this.
