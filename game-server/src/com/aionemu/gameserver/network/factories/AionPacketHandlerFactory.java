...
public class AionPacketHandlerFactory {
	...
	public AionPacketHandlerFactory() {
		...
		addPacket(new CM_CHECK_MAIL_LIST(0x127, State.IN_GAME));
		addPacket(new CM_CHECK_MAIL_UNK(0x1B7, State.IN_GAME));
		...
		addPacket(new CM_GM_COMMAND(0xCB, State.IN_GAME));
		...
		addPacket(new CM_BROKER_SETTLE_ACCOUNT(0x124, State.IN_GAME));
		addPacket(new CM_BROKER_SETTLE_LIST(0x143, State.IN_GAME));
		...
		addPacket(new CM_COMPOSITE_STONES(0x192, State.IN_GAME));
		...
		addPacket(new CM_ATREIAN_PASSPORT(0x1DA, State.IN_GAME));
		...
		addPacket(new CM_SECURITY_TOKEN(0x13E, State.CONNECTED, State.AUTHED, State.IN_GAME));
		...
		addPacket(new CM_FRIEND_SET_MEMO(0x1B1, State.IN_GAME));
		...
		addPacket(new CM_SELECT_DECOMPOSABLE(0x18E, State.IN_GAME));
		addPacket(new CM_CHARGE_ITEM(0x110, State.IN_GAME));
		addPacket(new CM_UNWARP_ITEM(0x1B2, State.IN_GAME));
		addPacket(new CM_CHARACTER_EDIT(0xA9, State.AUTHED));
		addPacket(new CM_HOUSE_SCRIPT(0xE0, State.IN_GAME));
		...
		addPacket(new CM_BROKER_SELL_WINDOW(0x157, State.IN_GAME));
		addPacket(new CM_BROKER_REGISTERED(0x15F, State.IN_GAME));
