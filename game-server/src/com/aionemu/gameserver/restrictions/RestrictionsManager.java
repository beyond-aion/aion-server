...
public final class RestrictionsManager {
	...
	public static boolean canFly(Player player) {
		for (Restrictions restrictions : RESTRICTIONS[RestrictionMode.canFly.ordinal()]) {
			if (!restrictions.canFly(player))
				return false;
		}
		return true;
	}
	...
	public static boolean canGlide(Player player) {
		for (Restrictions restrictions : RESTRICTIONS[RestrictionMode.canGlide.ordinal()]) {
			if (!restrictions.canGlide(player))
				return false;
		}
		return true;
	}
