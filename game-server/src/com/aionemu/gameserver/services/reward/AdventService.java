...
public class AdventService {
	...
	private void initMaps() {
		// Snowman Skin
		rewards.get(1).add(new CustomSurveyItem(110900688, 1));
		// Legion Coin
		rewards.get(2).add(new CustomSurveyItem(186000199, 75));
		// Tea of Repose - 100% Recovery
		rewards.get(3).add(new CustomSurveyItem(162001057, 10));
		...
		rewards.get(12).add(new CustomSurveyItem(188053614, 1));
		// Ancient Coin
		rewards.get(13).add(new CustomSurveyItem(186000237, 1000));
		// [Event] Mithril Medal Box
		rewards.get(13).add(new CustomSurveyItem(188053667, 3));
		...
		// Major Danuar Relic
		rewards.get(18).add(new CustomSurveyItem(186000247, 5));
		// Crafting Boost Charm III - 100%
		rewards.get(19).add(new CustomSurveyItem(169620094, 2));
		// [Event] Drana Coffee
		rewards.get(20).add(new CustomSurveyItem(164002167, 10));
		// Daeva's Respite Coin
		rewards.get(20).add(new CustomSurveyItem(186000409, 100));
		...
		rewards.get(24).add(new CustomSurveyItem(188950019, 1));
	}
