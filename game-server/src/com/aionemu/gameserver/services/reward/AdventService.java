...
public class AdventService {
	...
	private void initMaps() {
		// Flamekissed Boarding Hat
		rewards.get(1).add(new CustomSurveyItem(125045437, 1));
		...
		// Snowkissed Boarding Outfit
		rewards.get(6).add(new CustomSurveyItem(110900738, 1));
		// Snowy Radama Egg
		rewards.get(7).add(new CustomSurveyItem(190020061, 1));
		// Ancient Coin
		...
		// Roaring Campfire
		rewards.get(20).add(new CustomSurveyItem(170115029, 1));
		...
		rewards.get(24).add(new CustomSurveyItem(188052999, 3));
