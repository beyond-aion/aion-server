...
public final class ScriptContextFactory {
	 ...
	 * 
	 * @param root
	 *          file that will be treated as root for compiler
	 * @param parent
	 *          parent of new ScriptContext
	 * @return ScriptContext with preset root file
	 */
	public static ScriptContext getScriptContext(String root, ScriptContext parent) {
